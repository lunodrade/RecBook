 ...
 */
    ...
    class tb_tagsPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('tb_tagsssearch', $this->dataset,
                array('pk_tag_cod', 'tag_nome'),
                array($this->RenderText('Pk Tag Cod'), $this->RenderText('Tag Nome')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('tb_tagsasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('pk_tag_cod', $this->RenderText('Pk Tag Cod')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('tag_nome', $this->RenderText('Tag Nome')));
        }
        ...
        {
            //
            // View column for pk_tag_cod field
            //
            $column = new TextViewColumn('pk_tag_cod', 'Pk Tag Cod', $this->dataset);
            ...
            //
            $column = new TextViewColumn('tag_nome', 'Tag Nome', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        {
            //
            // Edit column for tag_nome field
            //
            $editor = new TextEdit('tag_nome_edit');
            $editor->SetSize(20);
            $editor->SetMaxLength(20);
            $editColumn = new CustomEditColumn('Tag Nome', 'tag_nome', $editor, $this->dataset);
        ...
        public function GetModalGridDeleteHandler() { return 'tb_tags_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'tb_tagsGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new tb_tagsPage("tags.php", "tb_tags", GetCurrentUserGrantForDataSource("tb_tags"), 'UTF-8');
        $Page->SetShortCaption('Tabela Tags');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Tabela Tags');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("tb_tags"));
